...
\begin{figure}[!h]
    \centering
    \mbox{
        \subfigure[Primera comunidad formada por los miembros de la Oficina del Software libre]{
            \includegraphics[width=0.5\textwidth]{comunidades/c0}
            \label{c0}
        }
        \subfigure[Segunda comunidad formada por algunos amigos y cuentas externas]{
            \includegraphics[width=0.5\textwidth]{comunidades/c1}
            \label{c1}
        }
    }
    \mbox{
        \subfigure[Tercera comunidad formada por amigos de la facultad y mi pueblo]{
            \includegraphics[width=0.5\textwidth]{comunidades/c2}
            \label{c2}
        }
        \subfigure[Cuarta comunidad formada por amigos de mi instituto]{
            \includegraphics[width=0.5\textwidth]{comunidades/c3}
            \label{c3}
        }
    }
    \mbox{
        \subfigure[Quinta comunidad formada por amigos de murcia, los personajes de Big Bang Theory y bandas de música]{
            \includegraphics[width=0.5\textwidth]{comunidades/c4}
            \label{c4}
        }
        \subfigure[Sexta comunidad formada por amigos externos a la facultad]{
            \includegraphics[width=0.5\textwidth]{comunidades/c5}
            \label{c5}
        }
    }
    \caption{Comunidades más granes obtenidas por el algoritmo de Lovaina. El tamaño de los nodos corresponde a su grado de entrada y el coloreado, a su centralidad de vector propio.}
    \label{comunidades}
\end{figure}
